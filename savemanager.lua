...
local SaveManager = {} do
    ...
    SaveManager.Parser = {
        ...
        ColorPicker = {
            Save = function(idx, object)
                local entry = { type = "ColorPicker", idx = idx, value = object.Value:ToHex(), transparency = object.Transparency }
                if object.GetGradientStops then
                    local stops = object:GetGradientStops()
            ...
            Load = function(idx, data)
                if SaveManager.Library.Options[idx] then
                    ...
                    if data.stops and obj.SetGradientStops then
                        obj:SetGradientStops(data.stops)
                    end
